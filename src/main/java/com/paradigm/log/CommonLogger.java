...
public class CommonLogger {
	...
	private static Logger bloomInfoLog = LoggerFactory.getLogger("bloomInfo");

	public static void bloomInfo(String msg) {
	    bloomInfoLog.info(msg);
	}
